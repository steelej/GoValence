...
func (c *Client) GetQuizzes(orgUnitId int64, params url.Values) (*ObjectListPage[QuizReadData], error) {
	var out ObjectListPage[QuizReadData]
...
func (c *Client) GetQuizAttempts(orgUnitId, quizId int64, params url.Values) (*ObjectListPage[QuizAttemptData], error) {
	var out ObjectListPage[QuizAttemptData]
...
func (c *Client) GetQuizQuestions(orgUnitId, quizId int64, params url.Values) (*ObjectListPage[QuizQuestion], error) {
